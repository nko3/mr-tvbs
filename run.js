...
app.configure(function () {
    ...
    app.get('/client.html', function (req, res) {
        //根據Header判斷語系
        if (req.headers["accept-language"].substr(0, 5) == "zh-TW") lang = "zh";
        else if (req.headers["accept-language"].substr(0, 5) == "ja-JP") lang = "ja";
        else lang = "en";
...
var arrayContains = Array.prototype.indexOf ? function (arr, val) {
